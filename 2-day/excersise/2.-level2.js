...
var oracion4 = 'Él gana 5000 euros de salario por mes, bono anual de 10000 euros, cursos en línea de 15000 euros por mes.';
let salario = (oracion) => {
 salario = oracion.match(/\d+/g)
 salarioMes = salario[0];
 Bono = salario[1];
 cursoLinea = salario[2];
 return salarioAnual = parseInt((salarioMes * 12)) + parseInt((Bono)) + parseInt((cursoLinea * 12)) + ' Euros';
}

console.log(salario(oracion4))